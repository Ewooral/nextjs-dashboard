...
const CustomLoginForm = () => {
  ...
  return (
    <div className="border border-[#246dca] p-8 rounded-[1rem]">
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="relative z-0 w-full mb-6 group">
          <input
            ...
            {...register("floating_email", { required: true, maxLength: 30 })}
          />
          <label
        ...
        <div className="relative z-0 w-full mb-6 group">
          <input
            ...
            placeholder=" "
            required
            {...register("floating_password", {required: true, maxLength: 30})}
          />
          <label
